...
/*
 * Based on an implementation of Omar Hasan (omar dot hasan at insa-lyon dot fr)
 * http://liris.cnrs.fr/~ohasan/pprs/paillierdemo/Paillier.java
 * 
 * Modified by Eugénio Alves da Silva
 */
...
public class HomoAdd
{
    ...
    private static int modLength = 2048;                  // length in bits of the modulus n
